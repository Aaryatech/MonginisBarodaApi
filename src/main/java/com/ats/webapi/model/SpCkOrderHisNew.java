...
@Entity
public class SpCkOrderHisNew implements Serializable{
	@Id
	...
	public String toString() {
		return "SpCkOrderHisNew [spOrderNo=" + spOrderNo + ", frCode=" + frCode + ", spType=" + spType + ", spId="
				+ spId + ", frId=" + frId + ", itemId=" + itemId + ", menuId=" + menuId + ", spFlavourId=" + spFlavourId
				...
				+ ", isBillGenerated=" + isBillGenerated + ", spName=" + spName + ", menuTitle=" + menuTitle
				+ ", grnPer=" + grnPer + ", discPer=" + discPer + "]";
	}
